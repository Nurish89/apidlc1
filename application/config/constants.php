...
/*
//UAT
defined('BASE_URL')            OR define('BASE_URL', 'https://apiuat.renew-plus.com/'); 
defined('CRM_URL')             OR define('CRM_URL', 'https://crmuat.renew-plus.com/'); 
defined('OCBLINK')	       OR define('OCBLINK', 'https://prepro.m-ocb.com.vn:8889/');
defined('OCBUSERNAME')	       OR define('OCBUSERNAME','compasia_test');
defined('OCBPASSWORD')	       OR define('OCBPASSWORD','Abc@1234!');
*/
